...
<a class="navbar-brand" href="task-info.php"><span style="color: #5bcad9; font-weight: bold;"><?php echo $_SESSION["name"];?></span></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-nav-custom">
        ...
        <li <?php if($page_name == "Daily-Task-Report" ) {echo "class=\"active\"";
